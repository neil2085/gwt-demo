...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "com.demo.items.module" because\n';
  ...
  $wnd.__gwt_activeModules['com.demo.items.module'] = {
    'moduleName' : 'com.demo.items.module',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/com.demo.items.module.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['com.demo.items.module'].superdevmode = true;

  var expectedSuffix = '/com.demo.items.module.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + com.demo.items.module + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:com.demo.items.module';
  var devModeSessionKey = '__gwtDevModeSession:com.demo.items.module';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/com.demo.items.module/com.demo.items.module.nocache.js';
  ...
  $wnd.__gwt_activeModules['com.demo.items.module'].canRedirect = true;
  $wnd.__gwt_activeModules['com.demo.items.module'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING com.demo.items.module';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/com.demo.items.module?user.agent=' + ua + '&_callback=' + callback;
